...
\section{Robotica en mi proyecto}

Este proyecto está totalmente orientado a la programación de robots, para ser más preciso nos centraremos en robots móviles de tercera generación, estarán provistos de los sensores necesarios para ser programados bajo un comportamiento reactivo.

Nos encargaremos de programar a través de un lenguaje de programación visual el comportamiento de estos. 
